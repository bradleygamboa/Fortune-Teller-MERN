...
export default class App extends Component {
  ...
  render() {
    ...
    <footer className="text-center">
        <a target="_blank" href="http://www.bradleygamboa.me"><i className="fa fa-user-circle fa-2x" aria-hidden="true"></i></a>&nbsp;
        <a target="_blank" href="http://www.github.com/bradleygamboa"><i className="fa fa-github-square fa-2x" aria-hidden="true"></i></a>&nbsp;
        <a target="_blank" href="http://www.linkedin.com/in/bradleygamboa"><i className="fa fa-linkedin-square fa-2x" aria-hidden="true"></i></a>
    </footer>
